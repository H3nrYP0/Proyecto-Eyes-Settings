// =============================================================
// ServiceCard.jsx
// UBICACIÓN: src/features/home/components/Services/ServiceCard.jsx
//
// FIX: descripción completa visible, la tarjeta crece con el contenido.
// La altura ya no es fija — se adapta al texto.
// =============================================================
...
const getServiceIcon = (nombre = "", color = "currentColor", fontSize = "20px") => {
  ...
  if (lower.includes("limpie") || lower.includes("lentes") || lower.includes("montura")) return <Visibility {...iconProps} />;
  if (lower.includes("ajuste") || lower.includes("reparaci") || lower.includes("arregl")) return <Build {...iconProps} />;
  if (lower.includes("contacto") || lower.includes("busqueda") || lower.includes("búsqueda")) return <Search {...iconProps} />;
  if (lower.includes("examen") || lower.includes("consulta")) return <Description {...iconProps} />;
    ...
    <>
      <div
        style={{
          ...
          gap: "0.75rem",
          /* ← FIX: sin height fija, la tarjeta crece con el contenido */
          width: "100%",
      ...
      >
        ...
        <div style={{
          ...
          opacity: hovered ? 0 : 1, transition: "opacity 0.28s ease",
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: "0.85rem" }}>
          <div style={{
            width: "40px", height: "40px", background: iconBg,
            borderRadius: "0.6rem", display: "flex", alignItems: "center",
            justifyContent: "center", border: iconBorder,
        ...
        {/* Descripción — COMPLETA, sin clamp ni overflow oculto */}
        {servicio.descripcion && (
          <p style={{
            color: hovered ? "rgba(255,255,255,0.80)" : C.textLight,
            fontSize: "0.82rem",
            margin: 0,
            lineHeight: "1.65",
            transition: "color 0.28s ease",
            /* ← FIX: sin -webkit-line-clamp, sin overflow hidden */
        ...
        <div style={{
          ...
          <span style={{
            ...
            transition: "all 0.28s ease", whiteSpace: "nowrap", flexShrink: 0,
          }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.6rem", flexShrink: 0 }}>
            ...
            <button
              style={{
                ...
                transition: "all 0.28s ease", display: "flex", alignItems: "center",
                gap: "0.3rem", height: "26px", whiteSpace: "nowrap",
                fontFamily: "inherit", pointerEvents: hovered ? "auto" : "none",
              }}
              onClick={handleAgendarClick}
              onMouseEnter={(e) => { if (hovered) e.currentTarget.style.background = "rgba(255,255,255,0.18)"; }}
              onMouseLeave={(e) => { if (hovered) e.currentTarget.style.background = "rgba(255,255,255,0.10)"; }}
            >
