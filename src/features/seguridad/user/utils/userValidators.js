  // ============================================
  // VALIDADORES DE USUARIO ADMINISTRATIVO
  // ============================================
   ...
   * Valida el formulario de creación/edición de usuarios admin.
   * mode "create" → contraseña obligatoria
   * mode "edit"   → contraseña opcional (solo se valida si se escribió algo)
   */
